...
//               <button
//                 type="submit"
//                 className="flex items-center justify-center sm:justify-between gap-2 bg-black px-5 py-3 sm:rounded-full text-xs font-semibold tracking-wide hover:bg-re-600 transition"
//               >
//                 SUBSCRIBE NOW
