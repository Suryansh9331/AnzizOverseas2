...
const Footer = () => {
  return (
    <footer className="bg-[#0F0F0F] text-white font-poppins">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-12 py-12">
        
        {/* Top Section */}
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-10">
          {/* Left */}
          <div className="max-w-lg text-center lg:text-left">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-outfit font-bold mb-3 text-[#1DA1F2]">
              Get Started Now
            </h2>
            <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
              A creative agency speciali innovative and solutions to businesses
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <span className="w-10 h-10 flex items-center justify-center bg-[#1A1A1A] rounded-full shrink-0">
                <FaMapMarkerAlt className="text-[#1DA1F2] text-lg" />
              </span>
              <div>
                <p className="text-xs sm:text-sm text-gray-400">Address</p>
          ...
          {/* Quick Links */}
          <div className="grid grid-cols-2 gap-x-12 gap-y-3 text-gray-300 text-sm text-center md:text-left">
            <a href="#" className="hover:text-white transition">
              » About us
            </a>
            <a href="#" className="hover:text-white transition">
          ...
          <div className="w-full">
            <form className="flex flex-col sm:flex-row items-stretch bg-[#1A1A1A] rounded-full overflow-hidden">
              ...
              <button
                type="submit"
                className="flex items-center justify-center gap-2 bg-black px-5 py-3 sm:rounded-full text-xs sm:text-sm font-semibold tracking-wide hover:bg-red-600 transition"
              >
                SUBSCRIBE NOW
                <span className="hidden sm:block w-[51px] h-[40px]">
                  <svg
                    width="71"
                    height="40"
                    viewBox="0 0 71 40"
        ...
        {/* Bottom Section */}
        <div className="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center text-xs sm:text-sm text-gray-400 gap-4">
          <p className="text-center md:text-left">
            © Yoursitename 2024 | All Rights Reserved
          </p>
